...
public class EstoqueTela extends javax.swing.JInternalFrame {
   ...
   DefaultTableModel Modelo;
    ...
    private void initComponents() {
        ...
        TXT_NCM = new JFormattedTextField(Formatotel);
    ...
    EstoqueB.setQuantidade(TXT_Quantidade.getText());
    EstoqueB.setValor(TXT_Valor.getText());
    EstoqueB.setNF(TXT_NF.getText());
    EstoqueB.setNCM(TXT_NCM.getText());
    }
